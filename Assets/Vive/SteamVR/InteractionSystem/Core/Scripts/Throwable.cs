...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Throwable : MonoBehaviour
    {
        ...
        //     forceHand = hand.transform;
        // }

        // private void Update()
        // {
        //     Debug.Log(forceHand.transform.name);
        //     if (forceHand)
        //     {
        //         Rigidbody rb = GetComponent<Rigidbody>();
        //         rb.AddForce((forceHand.transform.position - transform.position) * 1000, ForceMode.Force);
        //     }
        // }
        ...
        private void OnAssignHoverTo(Hand hand)
        {
            Debug.Log("on assign hover to called.");
        }
    }
}
