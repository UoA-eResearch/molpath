...
namespace ViveUISelection
{
    ...
    /// </summary>
    [RequireComponent(typeof(SteamVR_Camera))]
    public class VivePhysicsRaycaster : UnityEngine.EventSystems.BaseRaycaster
    {
        /// <summary>
        ...
        protected VivePhysicsRaycaster()
        { }
        ...
        public override Camera eventCamera
        {
            get
            {
                return GetComponent<SteamVR_Camera>().camera;
            }
        }
