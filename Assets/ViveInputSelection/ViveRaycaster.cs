...
namespace ControllerSelection
{
    ...
    public class ViveRaycaster : GraphicRaycaster, UnityEngine.EventSystems.IPointerEnterHandler
    {
        ...
        {
            ViveInputModule inputModule = UnityEngine.EventSystems.EventSystem.current.currentInputModule as ViveInputModule;
        ...
        {
            UnityEngine.EventSystems.PointerEventData ped = e as ViveRayPointerEventData;
            if (ped != null)
            {
