...
namespace ViveInputs
{
    public class ViveInputModule : UnityEngine.EventSystems.PointerInputModule
    {
        ...
        [NonSerialized]
        public ViveRaycaster activeGraphicRaycaster;
        [Header("Dragging")]
        ...
        protected Dictionary<int, ViveRayPointerEventData> m_VRRayPointerData = new Dictionary<int, ViveRayPointerEventData>();


        protected bool GetPointerData(int id, out ViveRayPointerEventData data, bool create)
        {
            if (!m_VRRayPointerData.TryGetValue(id, out data) && create)
            {
                data = new ViveRayPointerEventData(eventSystem)
                {
                    pointerId = id,
                };
        ...
        protected MouseState GetGazePointerData()
        {
            ...
            ViveRayPointerEventData leftData;
            ...
            if (viveRaycaster)
            {
                ...
                leftData.position = viveRaycaster.GetScreenPosition(raycast);
